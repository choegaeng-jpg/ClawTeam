...
def test_do_post_rejects_urlencoded_path_separator_in_team_name(monkeypatch):
    class FakeTaskStore:
        def __init__(self, team_name: str):
...
def test_do_post_rejects_traversal_team_name(monkeypatch):
    class FakeTaskStore:
        def __init__(self, team_name: str):
            raise AssertionError("TaskStore should not be instantiated for traversal team names")
